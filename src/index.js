...
const app = express();
app.use(helmet());
app.use(cors({origin:['https://trackr.ga4specialist.com','https://ga4specialist.com','http://localhost:3000'],credentials:true}));
...
app.listen(PORT,()=>console.log(`Trackr backend on port ${PORT}`));
